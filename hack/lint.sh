...
# XXX For some hard to fathom reason, the CI reports errors that the local test does not - specifically SC3014 and SC3054, so, also ignoring these since we use bash
readonly hadolint_ignore=(--ignore DL3006 --ignore DL3029 --ignore DL4006 --ignore DL3059 --ignore SC2039 --ignore SC2027 --ignore SC3014 --ignore SC3054)
